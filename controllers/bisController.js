...
exports.index = function(req, res, err) {   
    ...
    // }, function(err, results) {
      res.render('index', { title: 'Safemaster: Business Information System Home', error: err});
    //   res.render('index', { title: 'Business Information System Home', error: err, data: results });
